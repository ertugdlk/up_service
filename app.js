...
//CORS Settings
const whitelist = ['https://ertug-2.d4u99xidnqjcw.amplifyapp.com','http://localhost:3000', '213.243.44.6:27015']
const corsOptions = {
...
App.use(Cors({origin: false ,allowedHeaders:'*' ,credentials:true}))
App.use(Cookie())
